...
export default {
  ...
  methods: {
    ...
    //     if (badwords.includes(content[n])) {
    //       console.log('비속어 감지!')
    //       this.comment.content = '비속어가 포함된 댓글입니다.'
    //       break
    //     }
    //   }
    // }
