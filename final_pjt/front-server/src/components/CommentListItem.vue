<template>
  <div class="comment-content-box">
    ...
    <div class="com-con-box">
      ...
      <p class="com-con-box_content">{{badwordFilterOn}}</p>
...
export default {
  ...
  computed: {
    badwordFilterOn() {
      const filterOn = this.$store.state.badwordFilter
